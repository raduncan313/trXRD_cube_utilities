classdef Cube < handle
    ...
    methods
        ...
        function f = auto_signal_GUI(obj, params)
            ...
            txt_nc = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.5 4/5 0.2 0.05],...
            'style', 'text',...
            'string', sprintf('nc = %1$d', params.nc),...
            'fontsize', 12);

            sld_frac = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.7 3/5 0.25 0.05],...
            'style', 'slider',...
            'min', 0.01,...
            'max', 1,...
            'value', params.frac,...
            ...
            txt_frac = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.5 3/5 0.2 0.05],...
            'style', 'text',...
            'string', sprintf('frac = %1$d', params.frac),...
            'fontsize', 12);

            sld_minpts = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.7 2/5 0.25 0.05],...
            'style', 'slider',...
            'min', 1,...
            'max', 20,...
            'value', params.minpts,...
            ...
            txt_minpts = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.5 2/5 0.2 0.05],...
            'style', 'text',...
            'string', sprintf('minpts = %1$d', params.minpts),...
            'fontsize', 12);

            sld_eps = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.7 1/5 0.25 0.05],...
            'style', 'slider',...
            'min', 1,...
            'max', 20,...
            'value', params.eps,...
            ...
            txt_eps = uicontrol(f,...
            'units', 'normalized',...
            'position', [0.5 1/5 0.2 0.05],...
            'style', 'text',...
            'string', sprintf('eps = %1$d', params.eps),...
            'fontsize', 12);
            ...
            function callback(~,~)
                ...
                txt_nc.String = ['nc = ' num2str(params.nc)];
                txt_frac.String = ['frac = ' num2str(params.frac)];
                txt_minpts.String = ['minpts = ' num2str(params.minpts)];
                txt_eps.String = ['eps = ' num2str(params.eps)];
            ...
            function update_figure(f, params)
                ...
                [~, X_on, ~] = pca(on_flat_sc, 'NumComponents', params.nc);
    
                rng(42);
                [Mdl, has_signal] = ocsvm(X_on, 'contaminationfraction', params.frac,...
                    'kernelscale', 'auto');
    
                inds_1D = find(has_signal == true);
                [x, y] = ind2sub([sz(1), sz(2)], inds_1D);
                X_db = [x y];
                idx = dbscan(X_db, params.eps, params.minpts);
                idx_unq = unique(idx);
                idx_unq = idx_unq(idx_unq ~= -1);
                sigs_clsts = cell(1,length(idx_unq));
                inds_clsts = cell(1,length(idx_unq));
